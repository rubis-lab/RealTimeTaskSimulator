...
set output 'plot/distribution/dist_DC_H4.eps'
plot 'plot/distribution/dist_DC_H4.txt' u 3:4 w p not
set output 'plot/distribution/dist_DC_H42.eps'
plot 'plot/distribution/dist_DC_H4.txt' u 2:3 w p not
